...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        # party details
        result = self.client.get("/")
        self.assertIn(b"form-group", result.data)
        self.assertNotIn(b"Description", result.data)  
    ...
    def test_rsvp(self):
        ...
        # not the RSVP form
        self.assertNotIn(b"form-group", result.data)
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        ...
        self.assertIn(b"tom", result.data)
